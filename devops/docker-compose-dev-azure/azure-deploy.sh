...
projectname="herbodesonia"  # lower case, only
resourcegroup="herbodesonia_rg"
...
# git clone https://github.com/apilogicserver/herbodesonia.git
# cd herbodesonia
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name herbodesonia --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
