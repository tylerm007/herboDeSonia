...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 11.00.22, August 14, 2024 15:42:37):
...
api_logic_server__version = '11.00.22'
api_logic_server_created__on = 'August 14, 2024 15:42:37'
...
if __name__ == "__main__":
    ...
    msg = f'API Logic Project Loaded (WSGI), version 11.00.22\n'
    msg += f'.. startup message: {start_up_message}\n'
