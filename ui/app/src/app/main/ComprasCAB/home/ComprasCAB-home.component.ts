...
@Component({
  selector: 'ComprasCAB-home',
  templateUrl: './ComprasCAB-home.component.html',
  styleUrls: ['./ComprasCAB-home.component.scss']
})
export class ComprasCABHomeComponent implements AfterViewInit {
