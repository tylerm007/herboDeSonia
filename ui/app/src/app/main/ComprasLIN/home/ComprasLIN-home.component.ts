...
@Component({
  selector: 'ComprasLIN-home',
  templateUrl: './ComprasLIN-home.component.html',
  styleUrls: ['./ComprasLIN-home.component.scss']
})
export class ComprasLINHomeComponent implements AfterViewInit {
