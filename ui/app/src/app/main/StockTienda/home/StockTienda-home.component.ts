...
@Component({
  selector: 'StockTienda-home',
  templateUrl: './StockTienda-home.component.html',
  styleUrls: ['./StockTienda-home.component.scss']
})
export class StockTiendaHomeComponent implements AfterViewInit {
