...
@Component({
  selector: 'VentasCAB-home',
  templateUrl: './VentasCAB-home.component.html',
  styleUrls: ['./VentasCAB-home.component.scss']
})
export class VentasCABHomeComponent implements AfterViewInit {
