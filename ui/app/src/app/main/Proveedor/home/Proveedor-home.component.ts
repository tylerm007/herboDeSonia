...
@Component({
  selector: 'Proveedor-home',
  templateUrl: './Proveedor-home.component.html',
  styleUrls: ['./Proveedor-home.component.scss']
})
export class ProveedorHomeComponent implements AfterViewInit {
