...
@Component({
  selector: 'TraspasosLIN-home',
  templateUrl: './TraspasosLIN-home.component.html',
  styleUrls: ['./TraspasosLIN-home.component.scss']
})
export class TraspasosLINHomeComponent implements AfterViewInit {
