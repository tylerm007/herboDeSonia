...
@Component({
  selector: 'VentasLIN-home',
  templateUrl: './VentasLIN-home.component.html',
  styleUrls: ['./VentasLIN-home.component.scss']
})
export class VentasLINHomeComponent implements AfterViewInit {
